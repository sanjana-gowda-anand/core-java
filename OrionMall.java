class OrionMall {
    ...
    public static void main(String[] args) {
        ...
        String[] entertainment = {"PVR","GameZone","Bowling","KidsPlay","VRZone","Arcade","Trampoline","LaserTag","EscapeRoom","SnowWorld","WaterGames","FunCity","MiniGolf","GoKart","MirrorMaze"};
